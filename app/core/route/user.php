...
$router->add('user_id', '/(id:num)-(a:any)', 'UserController:index');
$router->add('user', '/users', 'UserController:users');
$router->add('user_admin', '/users/admin', 'UserController:users_admin');
$router->add('user_online', '/users/online', 'UserController:online');
$router->add('user_guest', '/users/guest', 'UserController:guest');
