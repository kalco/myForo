...
class Functions {
    ...
    function ending($num) {
        ...
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 == 1) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('time');
        } else {
            return $num . Cms::lang('times');
        }
    }
    ...
    function minute($num) {
        ...
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('minute');
        } else {
            return $num . Cms::lang('minutes');
        }
    }
    ...
    function hour($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('hour');
        } else {
            return $num . Cms::lang('hours');
        }
    }
    ...
    function month($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('month');
        } else {
            return $num . Cms::lang('months');
        }
    }
    ...
    function ending_user($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('f_user');
        } else {
            return $num . Cms::lang('f_users');
        }
    }
    ...
    function ending_quest($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('visitor');
        } else {
            return $num . Cms::lang('visitors');
        }
    }
    ...
    function ending_second($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('second');
        } else {
            return $num . Cms::lang('seconds');
        }
    }
    ...
    function ending_board($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('f_thread');
        } else {
            return $num . Cms::lang('f_threads');
        }
    }
    ...
    function ending_age($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 == 1) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('year');
        } else {
            return $num . Cms::lang('years');
        }
    }
    ...
    function message($num) {
        ...
        $num10 = $num % 10;
        if (($num100 >= 5 && $num100 <= 20) || ($num10 == 0) || ($num10 >= 5 && $num10 <= 9)) {
            return $num . Cms::lang('f_post');
        } else {
            return $num . Cms::lang('f_posts');
        }
    }
    ...
    function pagination($base_url, $start, $max_value, $num_per_page) {
        ...
        $pageindex = $start == 0 ? '' : sprintf($base_link, $start - $num_per_page, '<span class="glyphicon glyphicon-chevron-left"></span>');
        ...
        if ($start + $num_per_page < $max_value) {
            ...
            $pageindex .= sprintf($base_link, $display_page, '<span class="glyphicon glyphicon-chevron-right"></span>');
        }
        return $pageindex;
    }
    ...
    function name_replace($name) {
        //////////// Транслитируем имя ///////
        $trans1 = array("Ё", "Ж", "Ч", "Ш", "Щ", "Э", "Ю", "Я", "ё", "ж", "ч", "ш", "щ", "э", "ю", "я", "А", "Б", "В", "Г", "Д", "Е", "З", "И", "Й", "Ј", "К", "Ќ", "Л", "М", "Н", "Њ", "О", "П", "Р", "С", "Т", "У", "Љ", "Ф", "Х", "Ц", "Ы", "Ѓ", "Џ", "Ѕ", "а", "б", "в", "г", "д", "е", "з", "и", "й", "ј", "к", "ќ", "л", "м", "н", "њ", "о", "п", "р", "с", "т", "у", "ф", "х", "љ", "џ", "ѕ", "ѓ", "ц", "ь", "Ь", "Ъ", "ъ", "ы");
        
        $trans2 = array("JO", "ZH", "CH", "SH", "SCH", "JE", "JY", "JA", "jo", "zh", "ch", "sh", "sch", "je", "jy", "ja", "A", "B", "V", "G", "D", "E", "Z", "I", "J", "J", "K", "K", "L", "M", "N", "Nj", "O", "P", "R", "S", "T", "U", "Lj", "F", "H", "C", "Y", "Gj", "Dzj", "Dz", "a", "b", "v", "g", "d", "e", "z", "i", "j", "j", "k", "kj", "l", "m", "n", "nj", "o", "p", "r", "s", "t", "u", "f", "h", "lj", "dzj", "dz", "gj", "c", "q", "Q", "_", "_", "y");
