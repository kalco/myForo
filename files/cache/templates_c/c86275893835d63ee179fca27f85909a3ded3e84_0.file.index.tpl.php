<?php
/* Smarty version 3.1.30, created on 2017-09-15 18:37:05
  from "/home/l/lfatal1/kalco.ru/public_html/style/backend/flat/templates/admin/setting/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59bc01b15ba2b1_02278922',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c86275893835d63ee179fca27f85909a3ded3e84' => 
    array (
      0 => '/home/l/lfatal1/kalco.ru/public_html/style/backend/flat/templates/admin/setting/index.tpl',
      1 => 1505493422,
      2 => 'file',
    ),
  ),
...
function content_59bc01b15ba2b1_02278922 (Smarty_Internal_Template $_smarty_tpl) {
...
/setting/smiles" class="btn btn-xs btn-blue"><i class="clip-arrow-right"></i> <?php echo $_smarty_tpl->tpl_vars['lang']->value['smiles'];?>
</a>
      </div>
      <p>&nbsp;</p>
   </div>
      ...
      <div class="panel panel-default">
         ...
         <div class="panel-body">
            <div class="row">
               <div class="col-sm-12">
                  <div class="tabbable">
                     <ul id="myTab3" class="nav nav-tabs tab-teal" role="tablist">
                     ...
                     <span class="smart-wizard form-horizontal">
                           ...
                           <div class="tab-content">
                              <div id="system" class="tab-pane active">
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_url'];?>
:</label>
                                    <div class="col-sm-5">
                                       <input class="form-control" id="item" name="home" value="<?php echo smarty_modifier_esc($_smarty_tpl->tpl_vars['setup']->value['home']);?>
" type="text">
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_copyright'];?>
:</label>
                                    <div class="col-sm-5">
                                       <input class="form-control" id="item" name="copy" value="<?php echo htmlspecialchars(smarty_modifier_esc($_smarty_tpl->tpl_vars['setup']->value['copy']), ENT_QUOTES, 'UTF-8', true);?>
" type="text">
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_site_name'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_p_name'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_p_email'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['antiflood'];?>
: <br>
...
:</label>
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_message_page'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_p_template'];?>
</label>
                                    <div class="col-sm-5">
...
?>
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_template'];?>
:</label>
                                    <div class="col-sm-5">
...
?>
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_language'];?>
:</label>
                                    <div class="col-sm-5">
...
?>
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_time_zone'];?>
:</label>
                                    <div class="col-sm-5">
...
?>
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_p_log'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['compress_html'];?>
:</label>
                                    <div class="col-sm-5">
...
?>
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_highlight'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <?php }?>
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['point_create_thread'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['point_create_post'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['point_cost_login'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['ads_limit'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['allow_registration'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['email_activation'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_registration'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_width'];?>
: <br>
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_height'];?>
: <br>
                                    <small><i><?php echo $_smarty_tpl->tpl_vars['lang']->value['in_px'];?>
.</i></small></label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_f_size'];?>
: <br>
                                    <small><i><?php echo $_smarty_tpl->tpl_vars['lang']->value['in_px'];?>
.</i></small></label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_char'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_char_bg'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                              ...
                              <div id="forum" class="tab-pane">
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_new_thread'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_captcha_new_post'];?>
:</label>
                                    <div class="col-sm-5">
                                       <div class="make-switch switch-small" data-on="success" data-off="danger" data-on-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_on'];?>
" data-off-label="<?php echo $_smarty_tpl->tpl_vars['lang']->value['a_off'];?>
">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['allowed_file_format'];?>
:</label>
                                    <div class="col-sm-5">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['max_file_size'];?>
: <br>
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['max_file_in_post'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_time_old_thread'];?>
: <br>
                                    <small><i><?php echo $_smarty_tpl->tpl_vars['lang']->value['in_sec'];?>
.</i></small></label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_vote_options'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_last_thread_show'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_last_post_show'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['time_edit_post_user'];?>
: <br>
...
" type="text">
                              ...
                              <div id="email" class="tab-pane">
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_type_email'];?>
:</label>
                                    <div class="col-sm-5">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_smtp_port'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_smtp_host'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_smtp_username'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                                 ...
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_smtp_password'];?>
:</label>
                                    <div class="col-sm-5">
...
" type="text">
                              ...
                              <div id="counters" class="tab-pane">
                                 <div class="form-group">
                                    <label class="col-sm-5 control-label"><?php echo $_smarty_tpl->tpl_vars['lang']->value['a_ga'];?>
: <br>
