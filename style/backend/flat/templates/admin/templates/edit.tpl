<div class="head"><a href="{$home}{$panel}">Административная панель</a> / <a href="{$home}{$panel}/templates">{$title2}</a> / <a href="{$home}{$panel}/templates/view/{$skin.0}">{$skin.0}</a> / ../style/{$dirview}</div>
<div class="fon">
